...
We will briefly check the datastructure before we start plotting. Here I am using the [DT package](https://rstudio.github.io/DT/) which facilitates the display of dataframes, matrices or tibbles on HTLM pages.
...
## Themes
There are built in [ggplot themes](https://ggplot2.tidyverse.org/reference/ggtheme.html) and a long list of cosmetic changes you can make with [theme()](https://ggplot2.tidyverse.org/reference/theme.html).
