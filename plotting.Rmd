...
ggplot(penguins, aes(flipper_length_mm, fill = SPECIES_ORDER)) +
  ...
  theme(axis.text.x = element_text(color = "black", size = 12), 
        ...
        axis.title.y = element_text(color = "black", 
                                    face = "bold",size = 14), legend.title = element_text(color = "black", face = "bold", size = 14),
...
violin<-ggplot(na.omit(penguins), aes(x=sex, y=flipper_length_mm, fill=species))+
  geom_violin()+
  geom_boxplot(position=position_dodge(width=0.9), width=0.2) +
  scale_fill_manual(values = c("orange" , "purple", "#69b3a2"))+
  theme_bw()+
...
cowplot::plot_grid(horizontal_bar,
          violin,
          ncol = 1)
# Add "labels = c("A", "B")" to cowplot function
# ?plot_grid()

# Patchwork
horizontal_bar + violin + patchwork::plot_layout(ncol = 1)
```
