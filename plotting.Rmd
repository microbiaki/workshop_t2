...
In the exploration of the `palmerpenguins` data, we started with a simple plot and added to i
t. We added a linear model as a trendline, added model parameters to the plot, grouped the data by species, and changed things like point size and shape.
...
Each addtional layer adds something to the plot or modifies the plot defaults.
