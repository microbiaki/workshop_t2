...
## Boxplots
Let visualize the distribution of flipper length in thr different species and sexes using the function `geom_boxplot()` for create a [box and whiskers plot](https://ggplot2.tidyverse.org/reference/geom_boxplot.html):
